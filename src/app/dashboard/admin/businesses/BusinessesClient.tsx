                  ...
                  return (
                    ...
                    >
                      <div className="flex justify-between items-start gap-2">
                        ...
                        <span className={cn('text-[10px] font-semibold px-2 py-1 rounded-full capitalize shrink-0', cfg.color)}>
                          {cfg.label}
                        </span>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs pt-2 border-t border-border/50">
                        ...
                        <div>
                          ...
                          <span className={cn(
                            ...
                            biz.is_active ? 'bg-success/10 text-success' : 'bg-muted text-muted-foreground'
                          )}>
